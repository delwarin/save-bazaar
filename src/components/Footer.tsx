  ...
  <footer className="border-t bg-card mt-auto">
    <div className="container py-12">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="md:col-span-2">
          <Link to="/" className="flex items-center gap-2 mb-3">
            ...
            <span className="text-lg font-bold text-gradient-primary">অপচয়</span>
          </Link>
          <p className="text-sm text-muted-foreground leading-relaxed max-w-md">
            অপচয় কমান, সম্প্রদায়কে সাহায্য করুন। মেয়াদোত্তীর্ণ হওয়ার আগেই খাবার বিক্রি করুন, পুরাতন কাপড় ও বই দান করুন বা সাশ্রয়ী মূল্যে বিক্রি করুন। অপচয় আপনার পাশে।
          </p>
        </div>
      ...
      <div className="mt-8 pt-6 border-t text-center text-sm text-muted-foreground flex items-center justify-center gap-1">
        ...
        <span>অপচয় © {new Date().getFullYear()}</span>
      </div>
    </div>
  </footer>
);
